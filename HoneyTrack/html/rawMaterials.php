        ...
        <div class="content">
                ...
                <div class="wrapper">
                    ...
                    <div id="format1" class="format" style="display: none;">
                        ...
                        <!-- users forms -->
                        <form action="../php/insertRawMaterial.php" method="post">
                            ...
                            <section class="data">
                                <div class="addUsers">
                                    ...
                                    <div class="personalData">
                                        ...
                                        <div class="input-container">
                                            <input type="number" step="0.01" id="cost" name="cost" class="onlyNumbers" placeholder="Cost ($)" autocomplete="off" required>
